...
# APP_PATH = Path('/home', 'brett', 'Projects', 'psiz-app.git', 'rocks_Nosofsky_etal_2016')
# APP_PATH = Path('/Users', 'bdroads', 'Projects', 'psiz-app.git', 'rocks_Nosofsky_etal_2016')
...
def main():
    ...
    obs = Observations(judged_displays, n_select=n_select)
